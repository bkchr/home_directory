...
stdenv.mkDerivation {
  name = "superscale";
  buildInputs = [ myrust go openssl llvm minicom json_c qemu iw pkgconfig qemu clang socat godef gocode bluez docker_compose libseccomp nomad terraform goimports consul quilt cmake ];
